...
public fun execute_liquidation<RewardCoin>(
    ...
    assert!(liquidation_amount as u128 <= position::shares(position) * MAX_LIQUIDATION_RATIO / 10000, ELiquidationAmountTooLarge);
    ...
    let remaining_amount = liquidated_amount - penalty_amount - keeper_reward_amount - protocol_fee_amount;
